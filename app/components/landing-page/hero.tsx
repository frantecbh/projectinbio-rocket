...
export const Hero = () => {
  return (
    <div className="flex border">
     <div className="w-full flex flex-col mt-[35vh] border">
        ...
        <div className="flex items-center gap-2 w-full -mt-[10vh] border">
          <span className="text-white text-xl">projectinbio.com</span>
         <input type="text" />
         <button>Crirar agora</button>
        </div>
     </div>
     <div className="w-full felx items-center justify-center bg-[radial-gradient(circle_at_50%_50%, #4B2DBB, transparent_55%)]">
